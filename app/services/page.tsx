...
const tiers = [
  ...
  {
    name: "Enterprise",
    price: "Mulai dari Rp 14.900.000",
    description: "Web application kompleks: E-commerce, SaaS, Dashboard, atau Platform custom.",
    features: [
      "Arsitektur scalable (Next.js + NestJS/Go)",
      "Database PostgreSQL + Prisma ORM",
      "Authentication (NextAuth/Clerk) + RBAC",
      "Dashboard admin dengan chart & analytics",
      "E-commerce: Cart, Checkout, Payment Gateway (Midtrans/Xendit)",
      "Real-time notifications (WebSocket/SSE)",
      "API documentation (Swagger/OpenAPI)",
      "CI/CD pipeline (GitHub Actions + Docker)",
      "Monitoring (Sentry + LogRocket)",
      "Unlimited pages & fitur custom",
      "Hosting AWS/GCP + Load Balancer",
      "Support dedicated Slack/Email (90 hari)",
      "Dokumentasi teknis lengkap",
    ],
    limitations: [
      "Timeline minimal 8-12 minggu",
      "Memerlukan discovery phase terlebih dahulu",
      "Maintenance bulanan opsional (Rp 2.000.000/bln)",
      "IPR diserahkan setelah pembayaran lunas",
    ],
